      ...
      <div className="space-y-4">
        ...
        <div className="flex items-center justify-between border-b border-gray-200 pb-4">
          <h1 className="text-xl font-semibold text-gray-900">
            {properties.trackPackName || 'Track Pack'}
          </h1>
          <button
            onClick={onClose}
            className="p-2 hover:bg-gray-100 rounded-full transition-colors"
        ...
        <div>
          <p className="text-lg text-gray-700">
            {properties.lengthKM ? `${properties.lengthKM} km` : 'Length unknown'}
            {properties.lengthKM && properties.nbSteps && ', '}
            {properties.nbSteps ? `${properties.nbSteps} steps` : ''}
          </p>
        </div>
        ...
        <div className="bg-blue-50 p-4 rounded-lg border border-blue-200">
          <p className="text-sm text-gray-800 mb-4">
            For more information, to download and explore the detailed steps of the itinerary, download the mobile app
          </p>
